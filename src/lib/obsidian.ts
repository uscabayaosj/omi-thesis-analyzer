...
export function buildAdhdMarkdown(stored: StoredAdhdAnalysis): { markdown: string; filename: string } {
  ...
  // Reflection sections are omitted (not "None.") when absent: analyses stored
  // before the reflection pass existed have none, and an empty section header
  // would wrongly imply the pass ran and found nothing.
  const r = a.reflection;
...
${reflection}
---
*Generated by [[TRACE]] — ADHD Aid layer.*
`;
...
---
*Generated by [[TRACE]] — ADHD Aid daily rollup.*
`;
